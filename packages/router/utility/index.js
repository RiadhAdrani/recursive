...
export function flattenRoute(route) {
  ...
  if (
    ...
    typeof route.component !== "export function"
  )
    return {};
  ...
  const onLoad = typeof route.onLoad == "export function" ? route.onLoad : () => {};
  const onExit = typeof route.onExit == "export function" ? route.onExit : () => {};
  ...
  if (typeof route.component != "export function") {
    RecursiveConsole.error(
      "Recursive Router : router's component should be of type export function."
    );
  }
 ...
 */
export function resolvePath(destination, routes) {
 ...
 */
export function stripPathAndAnchor(destination) {
  /**
 ...
 */
export function findRouteOfForm(path, listOfRoutes) {
 ...
 */
export function isDynamicRoute(inputPath, routes) {
 ...
 */
export function preparePath(destination) {
 ...
 */
export function isDynamicFragment(pathFragment) {
 ...
 * @param {string} path
 */
export function fragmentize(path) {
 ...
 * @param {string} path
 */
export function areMatch(templatePath, path) {
 ...
 * @returns
 */
export function extractParams(templatePath, path) {
 ...
 * @param {import("../../../lib").FlatRoutes} routes
 */
export function findExactRoute(path, routes) {
