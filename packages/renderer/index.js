...
import { isValidChild, makeDiffList, isRecursiveElement } from "./utility";
  ...
  updateElement(element, newElement) {
    ...
    if (element.flags && element.flags.forceRerender === true) {
      ...
      const attributesDidChange =
        this.updateAttributes(element, newElement) && this.updateAttributes(element, newElement);
...
export { RecursiveRenderer, createElement };
